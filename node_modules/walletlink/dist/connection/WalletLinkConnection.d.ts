...
export declare class WalletLinkConnection {
     ...
     */
    constructor(sessionId: string, sessionKey: string, serverUrl: string, walletLinkAnalytics: WalletLinkAnalyticsAbstract, WebSocketClass?: typeof WebSocket);
    /**
