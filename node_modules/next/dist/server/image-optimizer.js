    ...
    try {
        ...
        if (upstreamType) {
            ...
            if (vector || animate) {
                ...
                sendResponse(req, res, url, maxAge, upstreamType, upstreamBuffer, isStatic, isDev, staleWhileRevalidate);
                return {
                    finished: true
                };
            }
        ...
        try {
            ...
            if (optimizedBuffer) {
                ...
                sendResponse(req, res, url, maxAge, contentType, optimizedBuffer, isStatic, isDev, staleWhileRevalidate);
            } else {
...
function sendResponse(req, res, url, maxAge, contentType, buffer, isStatic, isDev, staleWhileRevalidate) {
