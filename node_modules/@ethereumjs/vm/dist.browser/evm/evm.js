...
var EVM = /** @class */ (function () {
    ...
    EVM.prototype.executeMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, oldRefund, result, err;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (this._vm.DEBUG) {
                            debug("New message caller=".concat(message.caller, " gasLimit=").concat(message.gasLimit, " to=").concat(message.to ? message.to.toString() : '', " value=").concat(message.value, " delegatecall=").concat(message.delegatecall ? 'yes' : 'no'));
                        }
                    ...
                    case 8:
                        if (this._vm.DEBUG) {
                            debug("Received message results gasUsed=".concat(result.gasUsed, " execResult: [ gasUsed=").concat(result.gasUsed, " exceptionError=").concat(result.execResult.exceptionError ? result.execResult.exceptionError.toString() : '', " returnValue=").concat((0, util_1.short)(result.execResult.returnValue), " gasRefund=").concat(result.execResult.gasRefund, " ]"));
                        }
